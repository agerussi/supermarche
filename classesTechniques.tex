...
{\externalfigure[ECLIPSE-LUNA-SEQUENCES-AJOUTER-ARTICLE-CADBOT/classesAjouterArticleCadBot.pdf][width=\hsize]}

%\placefigure[][DC:RAC]{Détail des classes impliquées dans le \cu\ «RetirerArticleCadBot»}
%{\externalfigure[ECLIPSE-LUNA-SEQUENCES-RETIRER-ARTICLE-CADBOT/classesRetirerArticleCadBot.pdf][width=\hsize]}
