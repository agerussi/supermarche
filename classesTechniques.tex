...
\item le diagramme de la \in{figure}[DC:LC] correspond au \cu\ «Créer/DétruireListeConnectée», voir \in{section}[SS:CLC] et \in[SS:DLC].
Le diagramme de séquence correspondant est à la \in{figure}[DS:LC].
...
\placefigure[][DC:LC]{Détail des classes impliquées dans le \cu\ «Créer/SupprimerListeConnectée». Auteur: Congcong XU}
{\externalfigure[CROQUIS/listeConnecteeClassDiagramme.pdf][width=\hsize]}
