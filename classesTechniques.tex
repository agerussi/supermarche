...
\item le diagramme de la \in{figure}[DC:LC] correspond aux \cu\ «Créer/DétruireListeConnectée», voir \in{section}[SS:CLC] et \in[SS:DLC].
Les diagrammes de séquence correspondant sont aux \in{figures}[DS:CLC] et \in[DS:DLC].
...
\placefigure[][DC:LC]{Détail des classes impliquées dans le \cu\ «Créer/SupprimerListeConnectée»}
{\externalfigure[CROQUIS/DC_CreerListeConnectee.pdf][width=\hsize]}
