...
\startnote
\NC5 Cette fonctionalité est classique mais vraiment indispensable pour les clients qui désirent ne pas se servir d'un cadbot.
...
\NR5 Il s'agit de concevoir un système comparable à un GPS automobile.
...
\starttable[|c|r|c|c|c|]
  \HL
  \VL \bf rang\VL \bf \cu\VL \bf NC\VL \bf NR\VL \bf total\VL\FR \HL
  ...
  \VL \Num\VL PayerParTéléphone\VL ?\VL ?\VL ?\VL\MR \HL
  \VL N.C\VL \it UtiliserModeAutonome\VL 6\VL 1\VL 5\VL\MR \HL
  \VL N.C\VL \it UtiliserGuidageMarkettab\VL 8\VL 3\VL 5\VL\MR \HL
\stoptable}
