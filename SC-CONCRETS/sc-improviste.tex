...
\placefigure[][IMPROSCALE]{Mise à l'échelle d'une recette sur la markettab}{\externalfigure[CROQUIS/miseechelle_markettab.svg]}
Elle désélectionne le riz et les divers condiments (elle sait en avoir encore à la maison) et valide (\in{figure}[IMPROVALIDE]).
\placefigure[][IMPROSCALE]{Les articles nécessaires au poulet basquaise}{\externalfigure[CROQUIS/articles_poulet.svg]}
Son panier est maintenant rempli des articles nécessaires.
Elle se laisse guider au plus court dans le magasin (\in{figure}[IMPROGUIDAGE]), recueille les articles restants (2 poivrons jaunes, des lardons, des tomates): il lui suffit de sélectionner l'article suivant pour qu'il apparaisse sur le plan affiché sur la markettab.
\placefigure[][IMPROGUIDAGE]{Guidage sur la markettab}{\externalfigure[CROQUIS/guidage_markettab.svg]}
