...
Il se saisit donc d'une markettab (\in{figure}[MKT-LOG]) mais préfère prendre un caddie classique car il sait que le suivi automatique du cadbot peine parfois quand le trafic est dense. 

\placefigure[][MKT-LOG]{login sur la markettab}{\externalfigure[CROQUIS/marketTab-login-khalil.png][height=7truecm]}
...
\placefigure[][MKT-CRAPIDE]{guidage sur la markettab}{\externalfigure[CROQUIS/guidage-markettab-khalil.png][height=7truecm]}
