...
\placefigure[][lcon]{Page d'accueil du site \fm}{\externalfigure[CROQUIS/futurmarket-accueil.png][width=0.4\hsize]}
Là, il retrouve ses achats précédents groupés par date d'achat, ainsi qu'un menu qui lui permet de créer sa liste selon les derniers achats, selon des recettes qu'il choisira, ou avec une restriction budgétaire (\in{figure}[llogin]). 
...
Aujourd'hui, Congcong a une fin de mois difficile et sélectionne le menu budget (\in{figure}[BUDGET1]), puis définit un montant à ne pas dépasser.
\placefigure[][BUDGET1]{gestion de contraintes budgétaires}{\externalfigure[CROQUIS/marketTab_budget.png][width=0.6\hsize]}
