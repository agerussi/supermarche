...
\item la \in{figure}[DS:PP] correspond au \cu\ «PasserPortique», voir \in{section}[SS:CUD:PP].
...
\placefigure[][DS:PP]{DS du \cu\ «PasserPortique»}
{\externalfigure[ECLIPSE-LUNA-DS-PASSER-PORTIQUE/DSPasserPortique.pdf][width=\hsize]}
