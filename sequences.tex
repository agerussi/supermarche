...
\item la \in{figure}[DS:LC] correspond au \cu\ «???» présenté à la \in{section}[SS:??].
    \TODO\ très incomplet, simpliste, aucun objet modèle !!
% TO BE CONTINUED
\stopitemize
...
\placefigure[][DS:LC]{DS du \cu\ «??», auteur: Congcong Xu}
{\externalfigure[CROQUIS/DSlisteConnectee.jpg][width=\hsize]}
% TO BE CONTINUED
