...
\item la \in{figure}[DS:LC] correspond au \cu\ «Ajouter/SupprimerRecetteConnectée» présenté à la \in{section}[SS:CLC] et \in[SS:DLC]. 
Le diagramme de classes correspondant est à la \in{figure}[DC:LC].
\TODO\ Problème: le DSS ne colle pas au CUD !
% TO BE CONTINUED
\stopitemize
...
\placefigure[][DS:LC]{DS du \cu\ «Créer/DétruireListeConnectée», auteur: Congcong Xu}
{\externalfigure[CROQUIS/listeConnecteeSequenceDiagramme.pdf][width=\hsize]}
% TO BE CONTINUED
